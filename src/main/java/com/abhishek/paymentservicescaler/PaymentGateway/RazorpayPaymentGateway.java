...
//        paymentLinkRequest.put("first_min_partial_amount",100);
        paymentLinkRequest.put("expire_by",1714149985);
        paymentLinkRequest.put("reference_id", "12345");
        paymentLinkRequest.put("description","Sample Payment Link for Scaler");
        JSONObject customer = new JSONObject();
        customer.put("name","+919000090000");
        customer.put("contact","Abhishek Shah");
